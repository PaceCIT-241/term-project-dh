...
INSERT INTO PokemonStats (PokemonID, Name, BaseStatTotal, Health, Attack, Defense, SpAttack, SpDefense, Speed)
SELECT PokemonID, Name, BaseStatTotal, Health, Attack, Defense, SpAttack, SpDefense, Speed
FROM Pokemon;
